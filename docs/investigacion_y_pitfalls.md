...
*   **La Regla:** El extractor DEBE configurarse para "fingir" ser un cliente 100% exento de PoToken, como **`android_vr`**, **`tv`** o **`tv_downgraded`**. La Fase 1 (Spike Técnico) debe validar dinámicamente cuál de estos clientes sigue funcionando de manera confiable. Si todos exigen DOM en el futuro, el ecosistema entero entrará en crisis.
